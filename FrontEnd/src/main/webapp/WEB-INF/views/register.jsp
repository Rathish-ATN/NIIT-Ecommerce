...
<script type="text/javascript" src="https://cdn.jsdelivr.com/jquery.validation/1.15.1.jquery.validate.min.js"></script>
...
<body>
	<div class="container">
		<c:url value="/all/register" var="url" />
		<form:form modelAttribute="customer" action="${url }" id="form">
			...
			<form:input path="user.username" id="user.username" type="text" />
			...
			<br>
		Shipping Address is same as Billing Address <input type="checkbox"
